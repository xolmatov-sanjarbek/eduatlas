    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center mb-16">
          <div
            className={`inline-flex items-center gap-2 bg-emerald-100 text-emerald-700 px-4 py-2 rounded-full text-sm font-semibold mb-6 transition-all duration-700 ${isVisible ? "translate-y-0 opacity-100" : "-translate-y-4 opacity-0"}`}
          >
          ...
          <h2
            className={`text-4xl sm:text-5xl font-bold text-gray-900 mb-6 transition-all duration-700 delay-100 ${isVisible ? "translate-y-0 opacity-100" : "-translate-y-4 opacity-0"}`}
          >
          ...
          <p
            className={`text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed transition-all duration-700 delay-200 ${isVisible ? "translate-y-0 opacity-100" : "-translate-y-4 opacity-0"}`}
          >
        ...
        <div
          className={`bg-white rounded-3xl shadow-xl p-8 sm:p-12 mb-16 border border-emerald-100 transition-all duration-700 delay-300 ${isVisible ? "translate-y-0 opacity-100" : "translate-y-8 opacity-0"}`}
        >
          <div className="flex flex-col lg:flex-row items-center gap-8">
            <div className="lg:w-1/3 flex justify-center">
              <div className="relative">
                <div className="w-48 h-48 bg-linear-to-br from-emerald-400 to-emerald-600 rounded-3xl flex items-center justify-center shadow-2xl transform rotate-6 transition-transform duration-300 hover:rotate-12">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-16">
          {values.map((value, index) => (
            <div
              key={index}
              className={`bg-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-500 border border-emerald-50 hover:border-emerald-200 group ${isVisible ? "translate-y-0 opacity-100" : "translate-y-8 opacity-0"}`}
              style={{ transitionDelay: `${400 + index * 100}ms` }}
            >
              <div className="w-14 h-14 bg-linear-to-br from-emerald-400 to-emerald-600 rounded-xl flex items-center justify-center mb-5 group-hover:scale-110 transition-transform duration-300 shadow-lg">
        ...
        {/* Impact stats */}
        <div
          className={`bg-linear-to-r from-emerald-600 to-emerald-500 rounded-3xl p-10 sm:p-16 shadow-2xl transition-all duration-700 delay-700 ${isVisible ? "translate-y-0 opacity-100" : "translate-y-8 opacity-0"}`}
        >
        ...
        {/* Closing statement */}
        <div
          className={`text-center mt-16 transition-all duration-700 delay-900 ${isVisible ? "translate-y-0 opacity-100" : "translate-y-4 opacity-0"}`}
        >
