...
const steps = [
    {
        ...
        description: "Browse through thousands of scholarships from top universities worldwide. Filter by degree, country, and field of study.",
        color: "bg-blue-50",
    },
    {
        icon: <FileCheck className="w-8 h-8 text-emerald-600" />,
        title: "Verify Eligibility",
        description: "Review detailed requirements, deadlines, and benefits. Ensure you meet all criteria before proceeding to apply.",
        color: "bg-purple-50",
    },
    {
        icon: <Send className="w-8 h-8 text-emerald-600" />,
        title: "Direct Application",
        description: "Follow direct links to official university websites and start your application process with confidence.",
        color: "bg-emerald-50",
    }
];
        ...
        <section className="py-24 bg-white relative overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                <div className="text-center mb-20">
                    ...
                    >
                        Your journey to a global education starts here. We've simplified the scholarship search so you can focus on your studies.
                    </motion.p>
                </div>
                ...
                >
                    ...
                    <div className="hidden md:block absolute top-1/2 left-0 w-full h-0.5 bg-gradient-to-r from-transparent via-emerald-100 to-transparent -translate-y-1/2 z-0" />
                    ...
                    {steps.map((step, index) => (
                        ...
                        >
                            <div className={`w-20 h-20 ${step.color} rounded-[2rem] flex items-center justify-center mb-8 shadow-xl shadow-emerald-500/5 group-hover:scale-110 transition-transform duration-500 border border-white relative`}>
